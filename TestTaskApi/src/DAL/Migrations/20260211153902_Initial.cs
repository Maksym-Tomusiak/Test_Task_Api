    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    delete_requested_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_diary_entries_user_user_id",
                        column: x => x.user_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_entry_images_diary_entries_entry_id",
                        column: x => x.entry_id,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_diary_entries_user_id",
                table: "diary_entries",
                column: "user_id");

            migrationBuilder.CreateIndex(
                name: "ix_entry_images_entry_id",
                table: "entry_images",
                column: "entry_id");
