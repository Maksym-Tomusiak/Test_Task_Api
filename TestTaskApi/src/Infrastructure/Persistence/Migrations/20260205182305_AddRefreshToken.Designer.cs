...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260205182305_AddRefreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.DiaryEntries.DiaryEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_diary_entries_user_id");

                    b.ToTable("diary_entries", (string)null);
                });

            modelBuilder.Entity("Domain.EntryImages.EntryImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_entry_images");

                    b.HasIndex("EntryId")
                        .HasDatabaseName("ix_entry_images_entry_id");
            ...
            modelBuilder.Entity("Domain.Users.User", b =>
                {
                    ...
                    b.Property<DateTime>("DeleteRequestedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("delete_requested_at");
            ...
            modelBuilder.Entity("Domain.DiaryEntries.DiaryEntry", b =>
                {
                    b.HasOne("Domain.Users.User", "User")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_diary_entries_user_user_id");
            ...
            modelBuilder.Entity("Domain.EntryImages.EntryImage", b =>
                {
                    b.HasOne("Domain.DiaryEntries.DiaryEntry", "Entry")
                        .WithMany()
